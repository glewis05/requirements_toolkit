...
### TEST-RA-002: Verify unauthorized access is blocked
*❌ Negative*
...
### TEST-RA-003: Verify handling of special characters in input
*🔶 Edge Case*
...
### TEST-RA-005: Verify unauthorized access is blocked
*❌ Negative*
...
| Test ID | Category | Title | Pre-Requisites | Test Steps | Expected Results | MoSCoW | Est. Time | Notes |
|---------|----------|-------|----------------|------------|------------------|--------|-----------|-------|
| TEST-RA-006 | Recruitment Analytics | Verify Identify recruitment volume by... | User is logged in as user | Log in with appropriate credentials<br>Navigate to the relevant feature area<br>*...(4 total)* | • Feature works as described in the requirement<br>• Feature handles error cases gracefully<br>*...(3 total)* | Should Have | 8-10 min |  |
| TEST-RA-007 | Recruitment Analytics | Verify unauthorized access is blocked | User is logged in with appropriate role<br>Test data is prepared as specified | Log out of the system<br>Attempt to access the feature URL directly<br>*...(3 total)* | • User is redirected to login page<br>• No protected data is displayed<br>*...(3 total)* | Should Have | 5-7 min | Security test - verify auth... |

<details>
<summary><strong>Detailed Test Steps (click to expand)</strong></summary>

### TEST-RA-006: Verify Identify recruitment volume by program
*✅ Happy Path*
...
### TEST-RA-007: Verify unauthorized access is blocked
*❌ Negative*
...
| Test ID | Category | Title | Pre-Requisites | Test Steps | Expected Results | MoSCoW | Est. Time | Notes |
|---------|----------|-------|----------------|------------|------------------|--------|-----------|-------|
| TEST-RA-008 | Recruitment Analytics | Verify See where users stop in the co... | User is logged in as user<br>Test data exists in the system<br>*...(3 total)* | Log in as user with appropriate permissions<br>Navigate to the user view<br>*...(4 total)* | • Data is displayed within 3 seconds of page load<br>• Display updates when underlying data changes<br>*...(3 total)* | Should Have | 8-10 min |  |
| TEST-RA-009 | Recruitment Analytics | Verify unauthorized access is blocked | User is logged in with appropriate role<br>Test data is prepared as specified | Log out of the system<br>Attempt to access the feature URL directly<br>*...(3 total)* | • User is redirected to login page<br>• No protected data is displayed<br>*...(3 total)* | Should Have | 5-7 min | Security test - verify auth... |

<details>
<summary><strong>Detailed Test Steps (click to expand)</strong></summary>

### TEST-RA-008: Verify See where users stop in the consent process
*✅ Happy Path*
...
### TEST-RA-009: Verify unauthorized access is blocked
*❌ Negative*
...
| Test ID | Category | Title | Pre-Requisites | Test Steps | Expected Results | MoSCoW | Est. Time | Notes |
|---------|----------|-------|----------------|------------|------------------|--------|-----------|-------|
| TEST-RA-010 | Recruitment Analytics | Verify Monitor if emails are opened o... | Valid test user credentials are available<br>User account is not locked | Navigate to the login page<br>Enter valid username/email<br>*...(5 total)* | • Notification is sent within expected timeframe<br>• Notification includes all required information<br>*...(3 total)* | Must Have | 8-10 min | Verify across different bro... |
| TEST-RA-011 | Recruitment Analytics | Verify login fails with invalid password | User is logged in with appropriate role<br>Test data is prepared as specified | Navigate to login page<br>Enter valid username<br>*...(4 total)* | • Error message displayed (generic, not reveali...<br>• User remains on login page<br>*...(3 total)* | Should Have | 8-10 min | Do not reveal whether usern... |
| TEST-RA-012 | Recruitment Analytics | Verify login fails with non-existent ... | User is logged in with appropriate role<br>Test data is prepared as specified | Navigate to login page<br>Enter non-existent username<br>*...(4 total)* | • Same generic error message as invalid password<br>• No indication that user doesn't exist<br>*...(3 total)* | Should Have | 8-10 min | Prevents user enumeration a... |
| TEST-RA-013 | Recruitment Analytics | Verify unauthorized access is blocked | User is logged in with appropriate role<br>Test data is prepared as specified | Log out of the system<br>Attempt to access the feature URL directly<br>*...(3 total)* | • User is redirected to login page<br>• No protected data is displayed<br>*...(3 total)* | Should Have | 5-7 min | Security test - verify auth... |

<details>
<summary><strong>Detailed Test Steps (click to expand)</strong></summary>

### TEST-RA-010: Verify Monitor if emails are opened or ignored
*✅ Happy Path*
...
### TEST-RA-011: Verify login fails with invalid password
*❌ Negative*
...
### TEST-RA-012: Verify login fails with non-existent user
*❌ Negative*
...
### TEST-RA-013: Verify unauthorized access is blocked
*❌ Negative*
...
### TEST-RA-015: Verify form submission fails with missing required fields
*❌ Negative*
...
### TEST-RA-016: Verify form validation for invalid data format
*❌ Negative*
...
### TEST-RA-017: Verify unauthorized access is blocked
*❌ Negative*
...
### TEST-RA-018: Verify handling of maximum length input
*🔶 Edge Case*
...
### TEST-RA-019: Verify duplicate entry prevention
*🔶 Edge Case*
...
### TEST-RA-020: Verify handling of special characters in input
*🔶 Edge Case*
...
### TEST-RA-021: Verify minimum required field length
*📏 Boundary*
...
### TEST-RA-022: Verify numeric field minimum value
*📏 Boundary*
...
| Test ID | Category | Title | Pre-Requisites | Test Steps | Expected Results | MoSCoW | Est. Time | Notes |
|---------|----------|-------|----------------|------------|------------------|--------|-----------|-------|
| TEST-RA-023 | Recruitment Analytics | Verify Track users who decline to par... | User is logged in as user | Log in with appropriate credentials<br>Navigate to the relevant feature area<br>*...(4 total)* | • Feature works as described in the requirement<br>• Feature handles error cases gracefully<br>*...(3 total)* | Must Have | 8-10 min |  |
| TEST-RA-024 | Recruitment Analytics | Verify unauthorized access is blocked | User is logged in with appropriate role<br>Test data is prepared as specified | Log out of the system<br>Attempt to access the feature URL directly<br>*...(3 total)* | • User is redirected to login page<br>• No protected data is displayed<br>*...(3 total)* | Should Have | 5-7 min | Security test - verify auth... |

<details>
<summary><strong>Detailed Test Steps (click to expand)</strong></summary>

### TEST-RA-023: Verify Track users who decline to participate in the registry...
*✅ Happy Path*
...
### TEST-RA-024: Verify unauthorized access is blocked
*❌ Negative*
...
| Test ID | Category | Title | Pre-Requisites | Test Steps | Expected Results | MoSCoW | Est. Time | Notes |
|---------|----------|-------|----------------|------------|------------------|--------|-----------|-------|
| TEST-RA-025 | Recruitment Analytics | Verify Need to be able to pull list o... | User is logged in as user<br>User has permission to create records<br>*...(3 total)* | Navigate to the patient entry screen<br>Enter all required fields with valid data<br>*...(5 total)* | • Search results appear within 2 seconds<br>• Search matches are highlighted<br>*...(3 total)* | Must Have | 8-10 min | Test with both minimum and ... |
| TEST-RA-026 | Recruitment Analytics | Verify form submission fails with mis... | User is logged in with appropriate role<br>Test data is prepared as specified | Navigate to the data entry form<br>Leave required fields empty<br>*...(3 total)* | • Form submission is prevented<br>• Required fields are highlighted<br>*...(4 total)* | Should Have | 5-7 min | Verify error handling and u... |
| TEST-RA-027 | Recruitment Analytics | Verify form validation for invalid da... | User is logged in with appropriate role<br>Test data is prepared as specified | Navigate to the data entry form<br>Enter invalid format (e.g., letters in phone fi...<br>*...(3 total)* | • Validation error is displayed<br>• Invalid field is highlighted<br>*...(3 total)* | Should Have | 5-7 min | Verify error handling and u... |
| TEST-RA-028 | Recruitment Analytics | Verify unauthorized access is blocked | User is logged in with appropriate role<br>Test data is prepared as specified | Log out of the system<br>Attempt to access the feature URL directly<br>*...(3 total)* | • User is redirected to login page<br>• No protected data is displayed<br>*...(3 total)* | Should Have | 5-7 min | Security test - verify auth... |
| TEST-RA-029 | Recruitment Analytics | Verify handling of maximum length input | User is logged in with appropriate role<br>Test environment supports edge case data | Navigate to the entry form<br>Enter maximum allowed characters in text fields<br>*...(3 total)* | • System accepts input up to max length<br>• No truncation occurs without warning<br>*...(3 total)* | Could Have | 5-7 min | Edge case - verify robustness |
| TEST-RA-030 | Recruitment Analytics | Verify duplicate entry prevention | User is logged in with appropriate role<br>Test environment supports edge case data | Create a record with specific identifying data<br>Attempt to create another record with same iden...<br>*...(3 total)* | • Duplicate is detected<br>• Clear message about existing record<br>*...(3 total)* | Could Have | 5-7 min | May not apply if duplicates... |
| TEST-RA-031 | Recruitment Analytics | Verify handling of special characters... | User is logged in with appropriate role<br>Test environment supports edge case data | Navigate to the feature<br>Enter data containing special characters: < > &...<br>*...(4 total)* | • Special characters are properly escaped/encoded<br>• No XSS or injection vulnerabilities<br>*...(3 total)* | Could Have | 8-10 min | Security consideration - pr... |
| TEST-RA-032 | Recruitment Analytics | Verify minimum required field length | User is logged in with appropriate role<br>Boundary values are documented | Navigate to the form<br>Enter single character in a required text field<br>*...(3 total)* | • If minimum > 1, validation error displayed<br>• If minimum = 1, submission succeeds<br>*...(3 total)* | Could Have | 5-7 min | Boundary test - verify limi... |
| TEST-RA-033 | Recruitment Analytics | Verify numeric field minimum value | User is logged in with appropriate role<br>Boundary values are documented | Navigate to the form<br>Enter 0 or negative number in numeric field<br>*...(3 total)* | • Validation enforces minimum value<br>• Error message shows allowed range | Could Have | 5-7 min | Document actual min/max for... |

<details>
<summary><strong>Detailed Test Steps (click to expand)</strong></summary>

### TEST-RA-025: Verify Need to be able to pull list of patients who have...
*✅ Happy Path*
...
### TEST-RA-026: Verify form submission fails with missing required fields
*❌ Negative*
...
### TEST-RA-027: Verify form validation for invalid data format
*❌ Negative*
...
### TEST-RA-028: Verify unauthorized access is blocked
*❌ Negative*
...
### TEST-RA-029: Verify handling of maximum length input
*🔶 Edge Case*
...
### TEST-RA-030: Verify duplicate entry prevention
*🔶 Edge Case*
...
### TEST-RA-031: Verify handling of special characters in input
*🔶 Edge Case*
...
### TEST-RA-032: Verify minimum required field length
*📏 Boundary*
...
### TEST-RA-033: Verify numeric field minimum value
*📏 Boundary*
...
| Test ID | Category | Title | Pre-Requisites | Test Steps | Expected Results | MoSCoW | Est. Time | Notes |
|---------|----------|-------|----------------|------------|------------------|--------|-----------|-------|
| TEST-RA-034 | Recruitment Analytics | Verify Track amount of time spent on ... | User is logged in as user<br>User has permission to create records<br>*...(3 total)* | Navigate to the record entry screen<br>Enter all required fields with valid data<br>*...(5 total)* | • Feature works as described in the requirement<br>• Feature handles error cases gracefully<br>*...(3 total)* | Should Have | 8-10 min | Test with both minimum and ... |
| TEST-RA-035 | Recruitment Analytics | Verify form submission fails with mis... | User is logged in with appropriate role<br>Test data is prepared as specified | Navigate to the data entry form<br>Leave required fields empty<br>*...(3 total)* | • Form submission is prevented<br>• Required fields are highlighted<br>*...(4 total)* | Should Have | 5-7 min | Verify error handling and u... |
| TEST-RA-036 | Recruitment Analytics | Verify form validation for invalid da... | User is logged in with appropriate role<br>Test data is prepared as specified | Navigate to the data entry form<br>Enter invalid format (e.g., letters in phone fi...<br>*...(3 total)* | • Validation error is displayed<br>• Invalid field is highlighted<br>*...(3 total)* | Should Have | 5-7 min | Verify error handling and u... |
| TEST-RA-037 | Recruitment Analytics | Verify unauthorized access is blocked | User is logged in with appropriate role<br>Test data is prepared as specified | Log out of the system<br>Attempt to access the feature URL directly<br>*...(3 total)* | • User is redirected to login page<br>• No protected data is displayed<br>*...(3 total)* | Should Have | 5-7 min | Security test - verify auth... |
| TEST-RA-038 | Recruitment Analytics | Verify handling of maximum length input | User is logged in with appropriate role<br>Test environment supports edge case data | Navigate to the entry form<br>Enter maximum allowed characters in text fields<br>*...(3 total)* | • System accepts input up to max length<br>• No truncation occurs without warning<br>*...(3 total)* | Could Have | 5-7 min | Edge case - verify robustness |
| TEST-RA-039 | Recruitment Analytics | Verify duplicate entry prevention | User is logged in with appropriate role<br>Test environment supports edge case data | Create a record with specific identifying data<br>Attempt to create another record with same iden...<br>*...(3 total)* | • Duplicate is detected<br>• Clear message about existing record<br>*...(3 total)* | Could Have | 5-7 min | May not apply if duplicates... |
| TEST-RA-040 | Recruitment Analytics | Verify handling of special characters... | User is logged in with appropriate role<br>Test environment supports edge case data | Navigate to the feature<br>Enter data containing special characters: < > &...<br>*...(4 total)* | • Special characters are properly escaped/encoded<br>• No XSS or injection vulnerabilities<br>*...(3 total)* | Could Have | 8-10 min | Security consideration - pr... |
| TEST-RA-041 | Recruitment Analytics | Verify minimum required field length | User is logged in with appropriate role<br>Boundary values are documented | Navigate to the form<br>Enter single character in a required text field<br>*...(3 total)* | • If minimum > 1, validation error displayed<br>• If minimum = 1, submission succeeds<br>*...(3 total)* | Could Have | 5-7 min | Boundary test - verify limi... |
| TEST-RA-042 | Recruitment Analytics | Verify numeric field minimum value | User is logged in with appropriate role<br>Boundary values are documented | Navigate to the form<br>Enter 0 or negative number in numeric field<br>*...(3 total)* | • Validation enforces minimum value<br>• Error message shows allowed range | Could Have | 5-7 min | Document actual min/max for... |

<details>
<summary><strong>Detailed Test Steps (click to expand)</strong></summary>

### TEST-RA-034: Verify Track amount of time spent on each consent form page
*✅ Happy Path*
...
### TEST-RA-035: Verify form submission fails with missing required fields
*❌ Negative*
...
### TEST-RA-036: Verify form validation for invalid data format
*❌ Negative*
...
### TEST-RA-037: Verify unauthorized access is blocked
*❌ Negative*
...
### TEST-RA-038: Verify handling of maximum length input
*🔶 Edge Case*
...
### TEST-RA-039: Verify duplicate entry prevention
*🔶 Edge Case*
...
### TEST-RA-040: Verify handling of special characters in input
*🔶 Edge Case*
...
### TEST-RA-041: Verify minimum required field length
*📏 Boundary*
...
### TEST-RA-042: Verify numeric field minimum value
*📏 Boundary*
...
| Test ID | Category | Title | Pre-Requisites | Test Steps | Expected Results | MoSCoW | Est. Time | Notes |
|---------|----------|-------|----------------|------------|------------------|--------|-----------|-------|
| TEST-RA-043 | Recruitment Analytics | Verify Demographic comparison for var... | User is logged in as user<br>User has permission to create records<br>*...(3 total)* | Navigate to the record entry screen<br>Enter all required fields with valid data<br>*...(5 total)* | • Search results appear within 2 seconds<br>• Search matches are highlighted<br>*...(3 total)* | Should Have | 8-10 min | Test with both minimum and ... |
| TEST-RA-044 | Recruitment Analytics | Verify form submission fails with mis... | User is logged in with appropriate role<br>Test data is prepared as specified | Navigate to the data entry form<br>Leave required fields empty<br>*...(3 total)* | • Form submission is prevented<br>• Required fields are highlighted<br>*...(4 total)* | Should Have | 5-7 min | Verify error handling and u... |
| TEST-RA-045 | Recruitment Analytics | Verify form validation for invalid da... | User is logged in with appropriate role<br>Test data is prepared as specified | Navigate to the data entry form<br>Enter invalid format (e.g., letters in phone fi...<br>*...(3 total)* | • Validation error is displayed<br>• Invalid field is highlighted<br>*...(3 total)* | Should Have | 5-7 min | Verify error handling and u... |
| TEST-RA-046 | Recruitment Analytics | Verify unauthorized access is blocked | User is logged in with appropriate role<br>Test data is prepared as specified | Log out of the system<br>Attempt to access the feature URL directly<br>*...(3 total)* | • User is redirected to login page<br>• No protected data is displayed<br>*...(3 total)* | Should Have | 5-7 min | Security test - verify auth... |
| TEST-RA-047 | Recruitment Analytics | Verify handling of maximum length input | User is logged in with appropriate role<br>Test environment supports edge case data | Navigate to the entry form<br>Enter maximum allowed characters in text fields<br>*...(3 total)* | • System accepts input up to max length<br>• No truncation occurs without warning<br>*...(3 total)* | Could Have | 5-7 min | Edge case - verify robustness |
| TEST-RA-048 | Recruitment Analytics | Verify duplicate entry prevention | User is logged in with appropriate role<br>Test environment supports edge case data | Create a record with specific identifying data<br>Attempt to create another record with same iden...<br>*...(3 total)* | • Duplicate is detected<br>• Clear message about existing record<br>*...(3 total)* | Could Have | 5-7 min | May not apply if duplicates... |
| TEST-RA-049 | Recruitment Analytics | Verify handling of special characters... | User is logged in with appropriate role<br>Test environment supports edge case data | Navigate to the feature<br>Enter data containing special characters: < > &...<br>*...(4 total)* | • Special characters are properly escaped/encoded<br>• No XSS or injection vulnerabilities<br>*...(3 total)* | Could Have | 8-10 min | Security consideration - pr... |
| TEST-RA-050 | Recruitment Analytics | Verify minimum required field length | User is logged in with appropriate role<br>Boundary values are documented | Navigate to the form<br>Enter single character in a required text field<br>*...(3 total)* | • If minimum > 1, validation error displayed<br>• If minimum = 1, submission succeeds<br>*...(3 total)* | Could Have | 5-7 min | Boundary test - verify limi... |
| TEST-RA-051 | Recruitment Analytics | Verify numeric field minimum value | User is logged in with appropriate role<br>Boundary values are documented | Navigate to the form<br>Enter 0 or negative number in numeric field<br>*...(3 total)* | • Validation enforces minimum value<br>• Error message shows allowed range | Could Have | 5-7 min | Document actual min/max for... |

<details>
<summary><strong>Detailed Test Steps (click to expand)</strong></summary>

### TEST-RA-043: Verify Demographic comparison for various filters (gender,...
*✅ Happy Path*
...
### TEST-RA-044: Verify form submission fails with missing required fields
*❌ Negative*
...
### TEST-RA-045: Verify form validation for invalid data format
*❌ Negative*
...
### TEST-RA-046: Verify unauthorized access is blocked
*❌ Negative*
...
### TEST-RA-047: Verify handling of maximum length input
*🔶 Edge Case*
...
### TEST-RA-048: Verify duplicate entry prevention
*🔶 Edge Case*
...
### TEST-RA-049: Verify handling of special characters in input
*🔶 Edge Case*
...
### TEST-RA-050: Verify minimum required field length
*📏 Boundary*
...
### TEST-RA-051: Verify numeric field minimum value
*📏 Boundary*
...
| Test ID | Category | Title | Pre-Requisites | Test Steps | Expected Results | MoSCoW | Est. Time | Notes |
|---------|----------|-------|----------------|------------|------------------|--------|-----------|-------|
| TEST-OL-001 | Operational Logistics | Verify Enables Discover Research team... | User is logged in as user<br>Test data exists in the system<br>*...(3 total)* | Log in as user with appropriate permissions<br>Navigate to the order view<br>*...(4 total)* | • Search results appear within 2 seconds<br>• Search matches are highlighted<br>*...(3 total)* | Should Have | 8-10 min |  |
| TEST-OL-002 | Operational Logistics | Verify unauthorized access is blocked | User is logged in with appropriate role<br>Test data is prepared as specified | Log out of the system<br>Attempt to access the feature URL directly<br>*...(3 total)* | • User is redirected to login page<br>• No protected data is displayed<br>*...(3 total)* | Should Have | 5-7 min | Security test - verify auth... |

<details>
<summary><strong>Detailed Test Steps (click to expand)</strong></summary>

### TEST-OL-001: Verify Enables Discover Research team to order saliva kits via...
*✅ Happy Path*
...
### TEST-OL-002: Verify unauthorized access is blocked
*❌ Negative*
...
| TEST-DIW-002 | Data Integrity/Recruitment Workflow | Verify form submission fails with mis... | User is logged in with appropriate role<br>Test data is prepared as specified | Navigate to the data entry form<br>Leave required fields empty<br>*...(3 total)* | • Form submission is prevented<br>• Required fields are highlighted<br>*...(4 total)* | Should Have | 5-7 min | Verify error handling and u... |
| TEST-DIW-003 | Data Integrity/Recruitment Workflow | Verify form validation for invalid da... | User is logged in with appropriate role<br>Test data is prepared as specified | Navigate to the data entry form<br>Enter invalid format (e.g., letters in phone fi...<br>*...(3 total)* | • Validation error is displayed<br>• Invalid field is highlighted<br>*...(3 total)* | Should Have | 5-7 min | Verify error handling and u... |
| TEST-DIW-004 | Data Integrity/Recruitment Workflow | Verify unauthorized access is blocked | User is logged in with appropriate role<br>Test data is prepared as specified | Log out of the system<br>Attempt to access the feature URL directly<br>*...(3 total)* | • User is redirected to login page<br>• No protected data is displayed<br>*...(3 total)* | Should Have | 5-7 min | Security test - verify auth... |
| TEST-DIW-005 | Data Integrity/Recruitment Workflow | Verify handling of maximum length input | User is logged in with appropriate role<br>Test environment supports edge case data | Navigate to the entry form<br>Enter maximum allowed characters in text fields<br>*...(3 total)* | • System accepts input up to max length<br>• No truncation occurs without warning<br>*...(3 total)* | Could Have | 5-7 min | Edge case - verify robustness |
| TEST-DIW-006 | Data Integrity/Recruitment Workflow | Verify duplicate entry prevention | User is logged in with appropriate role<br>Test environment supports edge case data | Create a record with specific identifying data<br>Attempt to create another record with same iden...<br>*...(3 total)* | • Duplicate is detected<br>• Clear message about existing record<br>*...(3 total)* | Could Have | 5-7 min | May not apply if duplicates... |
| TEST-DIW-007 | Data Integrity/Recruitment Workflow | Verify handling of special characters... | User is logged in with appropriate role<br>Test environment supports edge case data | Navigate to the feature<br>Enter data containing special characters: < > &...<br>*...(4 total)* | • Special characters are properly escaped/encoded<br>• No XSS or injection vulnerabilities<br>*...(3 total)* | Could Have | 8-10 min | Security consideration - pr... |
| TEST-DIW-008 | Data Integrity/Recruitment Workflow | Verify minimum required field length | User is logged in with appropriate role<br>Boundary values are documented | Navigate to the form<br>Enter single character in a required text field<br>*...(3 total)* | • If minimum > 1, validation error displayed<br>• If minimum = 1, submission succeeds<br>*...(3 total)* | Could Have | 5-7 min | Boundary test - verify limi... |
| TEST-DIW-009 | Data Integrity/Recruitment Workflow | Verify numeric field minimum value | User is logged in with appropriate role<br>Boundary values are documented | Navigate to the form<br>Enter 0 or negative number in numeric field<br>*...(3 total)* | • Validation enforces minimum value<br>• Error message shows allowed range | Could Have | 5-7 min | Document actual min/max for... |

<details>
<summary><strong>Detailed Test Steps (click to expand)</strong></summary>

### TEST-DIW-001: Verify Cross validate participants entering through the MyChart...
*✅ Happy Path*
...
### TEST-DIW-002: Verify form submission fails with missing required fields
*❌ Negative*
...
### TEST-DIW-003: Verify form validation for invalid data format
*❌ Negative*
...
### TEST-DIW-004: Verify unauthorized access is blocked
*❌ Negative*
...
### TEST-DIW-005: Verify handling of maximum length input
*🔶 Edge Case*
...
### TEST-DIW-006: Verify duplicate entry prevention
*🔶 Edge Case*
...
### TEST-DIW-007: Verify handling of special characters in input
*🔶 Edge Case*
...
### TEST-DIW-008: Verify minimum required field length
*📏 Boundary*
...
### TEST-DIW-009: Verify numeric field minimum value
*📏 Boundary*
...
| Test ID | Category | Title | Pre-Requisites | Test Steps | Expected Results | MoSCoW | Est. Time | Notes |
|---------|----------|-------|----------------|------------|------------------|--------|-----------|-------|
| TEST-DIW-010 | Data Integrity/Recruitment Workflow | Verify Once cross validation is confi... | User is logged in as user<br>Validation service is accessible<br>*...(3 total)* | Navigate to the validation feature<br>Enter the data to be validated<br>*...(5 total)* | • Feature works as described in the requirement<br>• Feature handles error cases gracefully<br>*...(3 total)* | Must Have | 8-10 min |  |
...
| TEST-DIW-012 | Data Integrity/Recruitment Workflow | Verify unauthorized access is blocked | User is logged in with appropriate role<br>Test data is prepared as specified | Log out of the system<br>Attempt to access the feature URL directly<br>*...(3 total)* | • User is redirected to login page<br>• No protected data is displayed<br>*...(3 total)* | Should Have | 5-7 min | Security test - verify auth... |

<details>
<summary><strong>Detailed Test Steps (click to expand)</strong></summary>

### TEST-DIW-010: Verify Once cross validation is confirmed, a patient is allowed...
*✅ Happy Path*
...
### TEST-DIW-011: Verify validation handles invalid data
*❌ Negative*
...
### TEST-DIW-012: Verify unauthorized access is blocked
*❌ Negative*
...
### TEST-PEU-002: Verify unauthorized access is blocked
*❌ Negative*
...
| Test ID | Category | Title | Pre-Requisites | Test Steps | Expected Results | MoSCoW | Est. Time | Notes |
|---------|----------|-------|----------------|------------|------------------|--------|-----------|-------|
| TEST-PEU-003 | Participant Experience/Recruitment UX | Verify Allows for researchers to reac... | User is logged in as user<br>User has permission to create records<br>*...(3 total)* | Navigate to the patient entry screen<br>Enter all required fields with valid data<br>*...(5 total)* | • Search results appear within 2 seconds<br>• Search matches are highlighted<br>*...(3 total)* | Must Have | 8-10 min | Test with both minimum and ... |
| TEST-PEU-004 | Participant Experience/Recruitment UX | Verify form submission fails with mis... | User is logged in with appropriate role<br>Test data is prepared as specified | Navigate to the data entry form<br>Leave required fields empty<br>*...(3 total)* | • Form submission is prevented<br>• Required fields are highlighted<br>*...(4 total)* | Should Have | 5-7 min | Verify error handling and u... |
| TEST-PEU-005 | Participant Experience/Recruitment UX | Verify form validation for invalid da... | User is logged in with appropriate role<br>Test data is prepared as specified | Navigate to the data entry form<br>Enter invalid format (e.g., letters in phone fi...<br>*...(3 total)* | • Validation error is displayed<br>• Invalid field is highlighted<br>*...(3 total)* | Should Have | 5-7 min | Verify error handling and u... |
| TEST-PEU-006 | Participant Experience/Recruitment UX | Verify unauthorized access is blocked | User is logged in with appropriate role<br>Test data is prepared as specified | Log out of the system<br>Attempt to access the feature URL directly<br>*...(3 total)* | • User is redirected to login page<br>• No protected data is displayed<br>*...(3 total)* | Should Have | 5-7 min | Security test - verify auth... |
| TEST-PEU-007 | Participant Experience/Recruitment UX | Verify handling of maximum length input | User is logged in with appropriate role<br>Test environment supports edge case data | Navigate to the entry form<br>Enter maximum allowed characters in text fields<br>*...(3 total)* | • System accepts input up to max length<br>• No truncation occurs without warning<br>*...(3 total)* | Could Have | 5-7 min | Edge case - verify robustness |
| TEST-PEU-008 | Participant Experience/Recruitment UX | Verify duplicate entry prevention | User is logged in with appropriate role<br>Test environment supports edge case data | Create a record with specific identifying data<br>Attempt to create another record with same iden...<br>*...(3 total)* | • Duplicate is detected<br>• Clear message about existing record<br>*...(3 total)* | Could Have | 5-7 min | May not apply if duplicates... |
| TEST-PEU-009 | Participant Experience/Recruitment UX | Verify handling of special characters... | User is logged in with appropriate role<br>Test environment supports edge case data | Navigate to the feature<br>Enter data containing special characters: < > &...<br>*...(4 total)* | • Special characters are properly escaped/encoded<br>• No XSS or injection vulnerabilities<br>*...(3 total)* | Could Have | 8-10 min | Security consideration - pr... |
| TEST-PEU-010 | Participant Experience/Recruitment UX | Verify minimum required field length | User is logged in with appropriate role<br>Boundary values are documented | Navigate to the form<br>Enter single character in a required text field<br>*...(3 total)* | • If minimum > 1, validation error displayed<br>• If minimum = 1, submission succeeds<br>*...(3 total)* | Could Have | 5-7 min | Boundary test - verify limi... |
| TEST-PEU-011 | Participant Experience/Recruitment UX | Verify numeric field minimum value | User is logged in with appropriate role<br>Boundary values are documented | Navigate to the form<br>Enter 0 or negative number in numeric field<br>*...(3 total)* | • Validation enforces minimum value<br>• Error message shows allowed range | Could Have | 5-7 min | Document actual min/max for... |

<details>
<summary><strong>Detailed Test Steps (click to expand)</strong></summary>

### TEST-PEU-003: Verify Allows for researchers to reach out to patients via SMS...
*✅ Happy Path*
...
### TEST-PEU-004: Verify form submission fails with missing required fields
*❌ Negative*
...
### TEST-PEU-005: Verify form validation for invalid data format
*❌ Negative*
...
### TEST-PEU-006: Verify unauthorized access is blocked
*❌ Negative*
...
### TEST-PEU-007: Verify handling of maximum length input
*🔶 Edge Case*
...
### TEST-PEU-008: Verify duplicate entry prevention
*🔶 Edge Case*
...
### TEST-PEU-009: Verify handling of special characters in input
*🔶 Edge Case*
...
### TEST-PEU-010: Verify minimum required field length
*📏 Boundary*
...
### TEST-PEU-011: Verify numeric field minimum value
*📏 Boundary*
...
|--------|-------------|----------|-------------|------------|------------|--------|
| REQ-ROW2 | Track number (N) of patients who rece... | GEN-154EE6 | Track number (N) of patient... | TEST-RA-001, TEST-RA-002 +1 | None | 🟡 Partial |
| REQ-ROW3 | Compare consent vs. decline consent r... | GEN-18FAA8-1 | Compare consent vs. decline... | TEST-RA-004, TEST-RA-005 | None | 🟢 Full |
| REQ-ROW4 | Identify recruitment volume by program | GEN-0FF982 | Identify recruitment volume... | TEST-RA-006, TEST-RA-007 | None | 🟢 Full |
| REQ-ROW5 | See where users stop in the consent p... | GEN-40F34F | See where users stop in the... | TEST-RA-008, TEST-RA-009 | None | 🟢 Full |
| REQ-ROW6 | Monitor if emails are opened or ignored | GEN-6061A2 | Monitor if emails are opene... | TEST-RA-010, TEST-RA-011 +2 | None | 🟢 Full |
| REQ-ROW7 | Monitor which users opt out of remind... | GEN-43775F | Monitor which users opt out... | TEST-RA-014, TEST-RA-015 +7 | None | 🟢 Full |
| REQ-ROW8 | Track users who decline to participat... | GEN-2A9878 | Track users who decline to ... | TEST-RA-023, TEST-RA-024 | None | 🟢 Full |
| REQ-ROW9 | Need to be able to pull list of patie... | GEN-B2432A | Need to be able to pull lis... | TEST-RA-025, TEST-RA-026 +7 | None | 🟡 Partial |
| REQ-ROW10 | Track amount of time spent on each co... | GEN-105341 | Track amount of time spent ... | TEST-RA-034, TEST-RA-035 +7 | None | 🟢 Full |
| REQ-ROW11 | Demographic comparison for various fi... | GEN-DCEE2E | Demographic comparison for ... | TEST-RA-043, TEST-RA-044 +7 | None | 🟡 Partial |
| REQ-ROW12 | Enables Discover Research team to ord... | GEN-1AF5C9 | Enables Discover Research t... | TEST-OL-001, TEST-OL-002 | None | 🟢 Full |
| REQ-ROW13 | Cross validate participants entering ... | GEN-B7C9DB-1 | Cross validate participants... | TEST-DIW-001, TEST-DIW-002 +10 | None | 🟡 Partial |
| REQ-ROW14 | Show a personalized list of available... | GEN-44B0C4-1 | Show a personalized list of... | TEST-PEU-001, TEST-PEU-002 | None | 🟡 Partial |
| REQ-ROW16 | Allows for researchers to reach out t... | GEN-36C0C0 | Allows for researchers to r... | TEST-PEU-003, TEST-PEU-004 +7 | None | 🟡 Partial |
